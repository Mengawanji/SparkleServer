    ...
    <div class="container">
      ...
      <div class="section">
        ...
        <div class="price-breakdown">
          ...
          <div class="total-row">
            <span>Total Amount $${booking.totalPrice.toNumber().toFixed(2)}</span>
          </div>
        </div>
      </div

      <div class="footer">
        <p>Thank you for choosing Sandy's Sparkle Touch!</p>
        <p>If you have any questions, please contact us at sandyssparkletouch@gmail.com</p>
